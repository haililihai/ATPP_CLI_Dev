...
%disp(strcat(SUB{i},'_',num2str(CL_NUM)));
%disp(max(prob_cluster(:)));
...
%write the probabilistic maps
  for ki=1:CL_NUM
    ...
    filename_re=strcat(probpath,num2str(VOX_SIZE),'mm_',PART,'_',LR,'_',num2str(CL_NUM),'_',num2str(ki),'.nii.gz');
