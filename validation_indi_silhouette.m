function validation_indi_silhouette(PWD,PART,SUB_LIST,METHOD,VOX_SIZE,MAX_CL_NUM,POOLSIZE,MPM_THRES,LorR)
...
parfor ti=1:sub_num
    matrix_file=strcat(PWD,'/',sub{ti},'/',sub{ti},'_',PART,'_',LR,'_matrix/connection_matrix.mat');
    ...
    for kc=2:MAX_CL_NUM
        ...
        nii_file=strcat(PWD,'/',sub{ti},'/',sub{ti},'_',PART,'_',LR,'_',METHOD,'/',PART,'_',LR,'_',num2str(kc),'.nii');
